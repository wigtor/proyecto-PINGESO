...
@RequestScoped
public class MantenedorInspectorVerDetalles extends commonFunctions{
    ...
    private Integer numSolicitudesMantencionRealizadas;
    ...
    public void init() { 
        ...
        for(Inspector insp_iter : listaTemp){
            if(this.rut.equals(insp_iter.getUsuario().getRut()) ){
               ...
               this.numSolicitudesMantencionRealizadas = insp_iter.getSolicitudesMantencionRealizadas().size();
               break;
            }
        }
    ...
    public Integer getNumSolicitudesMantencionRealizadas() {
        return numSolicitudesMantencionRealizadas;
    }

    public void setNumSolicitudesMantencionRealizadas(Integer numSolicitudesMantencionRealizadas) {
        this.numSolicitudesMantencionRealizadas = numSolicitudesMantencionRealizadas;
    }
