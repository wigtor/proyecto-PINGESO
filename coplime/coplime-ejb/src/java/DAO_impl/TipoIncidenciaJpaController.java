...
public class TipoIncidenciaJpaController implements Serializable {
    ...
    public TipoIncidenciaJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(TipoIncidencia tipoIncidencia) throws RollbackFailureException, Exception {
    ...
    public void edit(TipoIncidencia tipoIncidencia) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
