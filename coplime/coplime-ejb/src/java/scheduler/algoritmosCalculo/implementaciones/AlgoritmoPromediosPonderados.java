...
public class AlgoritmoPromediosPonderados implements AlgoritmoCalculo {
    ...
    public Date estimar(Collection<HistoricoContenedor> historialContenedorOri, Integer porcentajeBuscado) {
        ...
        try {
            ...
            Logger.getLogger(AlgoritmoPromediosPonderados.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     */
     ...
     private double obtenerPendiente(LinkedList<HistoricoContenedor> historialContenedor) throws Exception{
        ...
        //Si el historial NO tiene elementos, lanzar una excepción
        if (historialContenedor.isEmpty() == true){
            //TODO recoger esta excepción
            //¿Retornar pendiente 0 en este caso?
            throw new Exception("Historial vacío");
        } else {
